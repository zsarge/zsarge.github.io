...
export default function CensorTetons() {
  ...
  return <>
    <p>
      As such, below you can {censored && <span class="line-through">not</span>} see the points (from left to right) Nez Perce, Grand Teton, and Teewiont Mountian.
    </p>
    { censored ? 
      <picture>
    ...
    <div class="flex items-center justify-center w-full">
        <button onClick={toggle} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
