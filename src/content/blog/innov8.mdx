...
Back to the CTF challenge, the source code comments make it really clear that V8 uses an insecure implementation, so I figure that's what we're going to exploit.
