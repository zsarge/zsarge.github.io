...
description: A walkthrough for some of the Injection problems in OWASP's Juice Shop
pubDate: 2023-10-10
seriesId: juice-shop
orderInSeries: 4
tags:
...
Let's take a look at the code snippet for this challenge (_slightly_ modified from the original):
...
That's our schema for _this_ database, leaked via SQL injection.
