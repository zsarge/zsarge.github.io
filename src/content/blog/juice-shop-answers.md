...
description: "A walkthrough for some of the XSS problems in OWASP's Juice Shop"
pubDate: "2023-09-26"
seriesId: juice-shop
orderInSeries: 2
tags:
...
From there, we can navigate to `/#/track-result/new?id=3f7b-e60171eddcbd36a5`, and see that the text is _reflected_ into the page:
...
So, now we need to perform a _persisted_ XSS attack.
