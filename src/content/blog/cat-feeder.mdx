...
In the end, we made a cat feeder, and a camera to record it.

## Initial Development

Initially, I wanted to do this project using only the tools available in the club room.

Note that we're in the middle of rennovations at the moment,
so this limited my focus largely to 3d-printing, and whatever spare motors and electronics I could find laying around.
