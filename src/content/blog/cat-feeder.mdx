...
For one, [we took a look on Amazon](https://www.amazon.com/s?k=Outdoor+cat+feeder), and found that it's possible to buy an automatic cat feeder,
...
Due to our school, we have a lot of free filament, so we decided to 3d print the pipe as well to save costs.
